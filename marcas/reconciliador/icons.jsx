/* ============================================
   Reconciliador — Set de ícones próprios
   Estilo: stroke 1.75, line-cap round, viewBox 32x32
   Vocabulário: reconciliação, comunhão, esperança, vida nova
============================================ */
...
/* —— Selo: cruz celta simplificada, ecoa o símbolo oficial —— */
function IconSelo(props) {
  return (
    <svg {...ICON_PROPS} {...props}>
      <path d="M16 4 V28" />
      <path d="M6 14 H26" />
...
/* —— Logo simples: dois ramos formando um coração —— */
function IconLogoReconciliador(props) {
  return (
    <svg {...ICON_PROPS} {...props}>
      <path d="M8 12 Q8 8 12 8 Q14 8 16 10 Q18 8 20 8 Q24 8 24 12 Q24 18 16 26 Q8 18 8 12" />
      <path d="M10 10 Q12 9 14 10" />
      <path d="M22 10 Q20 9 18 10" />
    </svg>
  );
}

const ReconciliadorIcons = {
  IconReconciliacao,
  IconBroto,
  IconFe,
  IconPaz,
  ...
  IconPalavra,
  IconVela,
  IconLogoReconciliador,
  IconSelo,
  IconLocal,
};

Object.assign(window, { ReconciliadorIcons });
