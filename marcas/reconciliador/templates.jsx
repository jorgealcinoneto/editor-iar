      ...
      <div className={'t-head' + (legible ? ' t-head--legible' : '')} style={compact ? { marginBottom: 32 } : {}}>
        <div className="t-mark">
          ...
          <div className="t-mark__text">
            <span>{line1}</span>
            <span className="t-mark__line2">{line2 || 'Reconciliador'}</span>
          </div>
        </div>
      ...
      <div className="t-print">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div className="t-mark">
            ...
            <div className="t-mark__text"><span>{line1}</span><span className="t-mark__line2">{line2 || 'Reconciliador'}</span></div>
          </div>
